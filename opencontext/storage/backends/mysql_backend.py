...
class MySQLBackend(IDocumentStorageBackend):
    ...
    def initialize(self, config: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            @sa_event.listens_for(self._pool, "checkout")
            def _ping_connection(dbapi_conn, connection_record, connection_proxy):
                try:
            ...
            # Create table structure using a pooled connection
            self._create_tables()
